    ...
    public GenerateJwtResult generateTokens(Map<String, Object> extraClaims, User user) {
        ...
        String refreshToken = Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 *
                        REFRESH_TOKEN_IN_HOURS))
                // .setExpiration(new Date(System.currentTimeMillis() + 1000 * 10 * 2))
                .compact();

        // Date expireTime = new Date(System.currentTimeMillis() + 1000 * 60 *
        //         ACCESS_TOKEN_IN_MINUTES);
        Date expireTime = new Date(System.currentTimeMillis() + 1000 * 10 * 1);
