        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(request -> request
                                                ...
                                                .requestMatchers(new AntPathRequestMatcher("/api/v1/register"))
                                                .permitAll()

                                                .requestMatchers(new AntPathRequestMatcher(REFRESH_TOKEN_URL))
                                                .permitAll()

                                                .requestMatchers(new AntPathRequestMatcher("/api/v1/reset-password"))
                                                .permitAll()
                                                .requestMatchers(new AntPathRequestMatcher("/api/v1/reset-password/**"))
                                                .permitAll()

                                                .requestMatchers(new AntPathRequestMatcher("/api/common/**"))
                                                .permitAll()
